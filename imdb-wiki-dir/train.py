...
args.store_name = f"{args.dataset}_{args.model}{args.store_name}_{args.optimizer}_{args.loss}_{args.lr}_{args.batch_size}_weight_norm_{args.weight_norm}_feature_norm_{args.norm}_oe_{args.oe}"
